...
Dans un bloc texte Avada : [arome_ifs_meteo]
Exemple Paris : [arome_ifs_meteo code="75056" departement="75" ville="Paris" heures="51"]

== Données ==
Les JSON départementaux sont publiés par GitHub Actions dans la branche data du dépôt alertesmeteo-hub/AROME-IFS-2.5-km.
...
Sources : Météo-France, Licence Ouverte 2.0 ; API Découpage administratif.
